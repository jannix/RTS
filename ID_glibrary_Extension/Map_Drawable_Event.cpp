...
int	Map_Drawable::Click(ID::Event* e)
{
	if (!this->_OnClick(e))
		return 0;
...
int	Map_Drawable::DoubleClick(ID::Event* e)
{
...
int	Map_Drawable::ClickDown(ID::Event* e)
{
	if (!this->_OnClickDown(e))
		return 0;
	int						i;
	std::vector<ID::Drawable*>::reverse_iterator	d_rit;
	std::vector<ID::Drawable*>::reverse_iterator	d_end;

	i = this->_grounds.size();
	while (i > 0)
	{
		--i;
		d_rit = this->_grounds[i].rbegin();
		d_end = this->_grounds[i].rend();
		while (d_rit != d_end)
		{
...
int	Map_Drawable::ClickUp(ID::Event* e)
{
...
int	Map_Drawable::Enter(ID::Event* e)
{
	if (!this->_OnEnter(e))
		return 0;
...
int	Map_Drawable::Leave(ID::Event* e)
{
	if (!this->_OnLeave(e))
		return 0;
...
int	Map_Drawable::Motion(ID::Event* e)
{
	if (!this->_OnMotion(e))
		return 0;
	int						i;
...
int	Map_Drawable::KeyUp(ID::Event* e)
{
	if (!this->_OnKeyUp(e))
		return 0;
...
int	Map_Drawable::KeyDown(ID::Event* e)
{
...
int	Map_Drawable::FocusEnter(ID::Event* e)
{
...
int	Map_Drawable::FocusLeave(ID::Event* e)
{
...
int	Map_Drawable::EnableChange(ID::Event* e)
{
...
int	Map_Drawable::ScreenChange(ID::Event* e)
{
...
int	Map_Drawable::Resize(ID::Event* e)
{
	if (!this->_OnResize(e))
		return 0;
	std::list<ID::Drawable*>::reverse_iterator	d_rit;
...
int	Map_Drawable::Quit(ID::Event* e)
{
	if (!this->_OnQuit(e))
		return 0;
	std::list<ID::Drawable*>::reverse_iterator	d_rit;
...
int	Map_Drawable::UserEvent(ID::Event* e)
{
